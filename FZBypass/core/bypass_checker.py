...
async def direct_link_checker(link, onlylink=False):
    ...
    # DDL Links
        ...
        blink = await transcript(link, "https://news.sagenews.in/", "https://movies.djnonstopmusic.in/", 10)
        ...
        blink = await transcript(link, "https://go.hostadviser.net/", "https://www.gyanitheme.com/", 8)
        ...
        blink = await transcript(link, "https://gadgets.webhostingtips.club/", "https://pubgmobileapk.one/", 10)
    elif bool(match(r"https?:\/\/tnvalue\.\S+", link)):
        blink = await transcript(link, "https://gadgets.webhostingtips.club/", "https://pubgmobileapk.one/", 10)
